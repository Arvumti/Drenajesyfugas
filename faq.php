...
<div class="marco_principal">
    ...
    <?php
$active_faq_mn= 'menu_multi_nivel active';
include('header.php');
?>
                    ...
                    <!-- <div class="row">
                  	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    		<div class="image-banner">
                         		<div class="mascara">
                                <div class="mascara_interno">
                                		<div class="contenido">
                                    	<h2> Soporte </h2>
                                        <span>Drenajes comunidad</span>
                                    </div>
                                </div>
                             </div>
                             <img src="placeholders/img/banner-forum.jpg"> 
                             <div class="clear"></div>  
                         </div>
                      </div>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    		<div class="image-banner">
                         		<a href="chat/index.php" class="mascara">
                                <div class="mascara_interno">
                                		<div class="contenido">
                                    	<h2> Chatea en vivo</h2>
                                        <span>Soporte 24/7</span>
                                    </div>
                                </div>
                             </a>
                             <img src="placeholders/img/banner-livechat.jpg"> 
                             <div class="clear"></div>  
                         </div>
                      </div>
                 	...
                 	<div  class="row">
                 		<div class="col-md-12">
                        <!-- <div class="division_interna linea_sobreada"></div> -->
                        
                       <div class="panel_grupo s_linea" id="accordion">
